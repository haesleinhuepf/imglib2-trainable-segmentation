...
/**
 * Wraps around a {@link hr.irb.fastRandomForest.FastRandomTree} and exposes
 * all the parameters (threshold, children and classification probabilities).
 * <p>
 * Java reflection is used to extract the parameter from the
 * weka fast random forest.
 */
public class TransparentRandomTree {
	...
	/**
	 * Returns the sub tree that is used if the attribute value is smaller than the threshold.
	 */
	...
	/**
	 * Returns the sub tree that is used if the attribute value is greater or equal to the threshold.
	 */
