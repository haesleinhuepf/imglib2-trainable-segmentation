 ...
 * <p>
 * A {@link GpuView} can also be a hyperSlice of a
 * {@link GpuImage}, this is the case if
...
public class GpuView implements AutoCloseable {
	...
	/**
	 * @return underlying {@link GpuImage}. This should only be used by low level functions.
	 */
	...
	/**
	 * @return The index of the pixel, in the underlying {@link GpuImage}, that is considered as the origin of the image.
	 */
	public long offset() {
		return offset;
	}
