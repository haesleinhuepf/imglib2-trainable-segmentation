...
public class GpuApi implements AutoCloseable {
	...
	public void gaussianBlur(ClearCLBuffer input, ClearCLBuffer output, double sX, double sY, double sZ) {
	...
	public void gaussianBlur3D(ClearCLBuffer inputBuffer, ClearCLBuffer output, int i, int i1, int i2) {
