...
public class GpuApi implements AutoCloseable {
	...
	public GpuImage push(RandomAccessibleInterval<? extends RealType> image) {
		ClearCLBuffer buffer = pool.create(Intervals.dimensionsAsLongArray(image), getNativeTypeEnum(image));
		RandomAccessibleIntervalToClearCLBufferConverter.copyRandomAccessibleIntervalToClearCLBuffer(image, buffer);
	...
	public void execute(Class<?> anchorClass, String kernelFile, String kernelName, long[] globalSizes, HashMap<String, Object> parameters, HashMap<String, Object> constants) {
