...
public class GaussTest {
	...
	public void test() {
		...
		RandomAccessibleInterval<FloatType> expected = Utils.create3dImage(Intervals.createMinMax(-2, -2, -2, 2, 2, 2),
		...
		try(
			...
			ClearCLBuffer output = clij.create(Intervals.dimensionsAsLongArray(targetInterval), NativeTypeEnum.Float);
		) {
