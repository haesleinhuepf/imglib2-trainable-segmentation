...
public class GaussTest {
	...
	public void test() {
		...
		RandomAccessibleInterval<FloatType> expected = RevampUtils.createImage(Intervals.createMinMax(-2, -2, -2, 2, 2, 2), new FloatType());
		...
		try(
				...
				ClearCLBuffer output = gpu.create(Intervals.dimensionsAsLongArray(targetInterval), NativeTypeEnum.Float);
		) {
