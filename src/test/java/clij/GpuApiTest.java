...
public class GpuApiTest {
	...
	public void testPushAndPull() {
		RandomAccessibleInterval<FloatType> image = ArrayImgs.floats(new float[]{1, 2, 3, 4, 5, 6}, 2, 3);
	...
	public void testPushAndPullMultiChannel() {
		RandomAccessibleInterval<FloatType> image = ArrayImgs.floats(new float[]{1, 2, 3, 4, 5, 6}, 2, 1, 3);
