...
public class SingleDifferenceOfGaussiansFeatureTest {
	...
	public void testDifferenceOfGaussians() {
		...
		RandomAccessibleInterval<FloatType> result = Views.hyperSlice(calculator.apply(dirac, interval), 2, 0);
	...
	public void test3d() {
		...
		RandomAccessibleInterval<FloatType> result = Views.hyperSlice(calculator3d.apply(input, interval), 3, 0);
		RandomAccessibleInterval<FloatType> expected = Utils.create3dImage(interval, ((x, y, z) -> Utils.gauss(
